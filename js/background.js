chrome.browserAction.onClicked.addListener(function (activeTab) {
  chrome.tabs.executeScript(null, {
    ...
    var htmlCode = "<html><head><link href='http://fonts.googleapis.com/css?family=Raleway:400,700' rel='stylesheet' type='text/css'></head><body style='font-family: Raleway, Helvetica, sans-serif; max-width: 992px; margin: 0 auto;'>" + result + "</body></html>";
